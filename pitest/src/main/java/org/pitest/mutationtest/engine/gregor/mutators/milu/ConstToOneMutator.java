...
public class ConstToOneMutator extends InlineConstantMutator {
  @Override
  public MethodVisitor create(final MutationContext context,
      final MethodInfo methodInfo, final MethodVisitor methodVisitor) {
    return new ConstToOneVisitor(context, methodVisitor);
  }

  protected class ConstToOneVisitor extends InlineConstantVisitor{

    ConstToOneVisitor(MutationContext context, MethodVisitor delegateVisitor) {

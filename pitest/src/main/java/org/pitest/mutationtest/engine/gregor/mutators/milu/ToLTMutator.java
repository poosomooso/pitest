...
public enum ToLTMutator implements MethodMutatorFactory {
  ...
  public MethodVisitor create(final MutationContext context,
    ...
    return new ToLTVisitor(this, context, methodVisitor);
  }
...
class ToLTVisitor extends AbstractJumpMutator {

  private static final String                     DESCRIPTION = "changed condition to less than";
...
//    MUTATIONS.put(Opcodes.IFLT, new Substitution(Opcodes.IFLT, DESCRIPTION));
    ...
    MUTATIONS.put(Opcodes.IF_ICMPGT, new Substitution(Opcodes.IF_ICMPLT,
        DESCRIPTION));
//    MUTATIONS.put(Opcodes.IF_ICMPLT, new Substitution(Opcodes.IF_ICMPLT,
//        DESCRIPTION));
  }

  ToLTVisitor(final MethodMutatorFactory factory,

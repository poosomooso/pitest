...
public enum ToEqualMutator implements MethodMutatorFactory {
  ...
  public MethodVisitor create(final MutationContext context,
    ...
    return new ToEqualVisitor(this, context, methodVisitor);
  }
...
class ToEqualVisitor extends AbstractJumpMutator {

  private static final String                     DESCRIPTION = "changed conditional to equals";
...
//        DESCRIPTION));
  ...
  ToEqualVisitor(final MethodMutatorFactory factory,

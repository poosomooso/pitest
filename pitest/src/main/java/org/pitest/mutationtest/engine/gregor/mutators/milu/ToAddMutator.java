...
public enum ToAddMutator implements MethodMutatorFactory {
  ...
  public MethodVisitor create(final MutationContext context,
    ...
    return new ToAddVisitor(this, methodInfo, context, methodVisitor);
  }
...
class ToAddVisitor extends AbstractInsnMutator {

  ToAddVisitor(final MethodMutatorFactory factory,
